...
class LocalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locality" do
    assert_difference("Locality.count") do
      post localities_url, params: { locality: { active_status: @locality.active_status, assigned_code: @locality.assigned_code, del_status: @locality.del_status, description: @locality.description, name: @locality.name, suburb_code: @locality.suburb_code } }
    end
  ...
  test "should update locality" do
    patch locality_url(@locality), params: { locality: { active_status: @locality.active_status, assigned_code: @locality.assigned_code, del_status: @locality.del_status, description: @locality.description, name: @locality.name, suburb_code: @locality.suburb_code } }
